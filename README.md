...
Unfortunately, because some resource packs rely on the default behavior of fallbacks, some models may not display correctly (especially in the GUI). Therefore, creators will have to slightly adapt their packs to work with the mod. This process will be described in the [Wiki](https://github.com/Danrus1100/rpf/blob/multiversion/PACK_DEVELOPERS.md).
